...
def add_time_headers(
    ...
    color_1 = color_toward_grey(color, grey_fraction=grey_fractions[0])
    color_2 = color_toward_grey(color, grey_fraction=grey_fractions[1])
    color_3 = color_toward_grey(color, grey_fraction=grey_fractions[2])
